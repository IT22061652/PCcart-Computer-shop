	...
	while (rs.next()) {
		...
		%>		
						...
						<tbody>
						 ...
						 <input type="text" name="tracking" id="lname" value="<%=rs.getString("status")%>"  />
							 <input type="hidden" name="id" id="lname" value="<%=rs.getInt("oid") %>" readonly />
									<button type="submit" class="status completed1">Upload Tracking</button>
					...
					<td><form action="<%= request.getContextPath() %>/cancelorder1" method="post">
